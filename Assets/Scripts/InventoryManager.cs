...
{
	// add an action event
	public delegate void OnRegisterItem(string itemName, int itemCount, Sprite sprite);
	public static event OnRegisterItem onRegisterItem;

	public Dictionary<string, int> inventory = new Dictionary<string, int>() { { "berry", 0 }, { "flax", 0 }, { "stone", 0 }, { "stick", 0 } };
