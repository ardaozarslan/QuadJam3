...
public class StartingPlayerText : Instanceton<StartingPlayerText>
{
	[ReorderableList]
	...
	private IEnumerator ShowPlayerTextCoroutine()
	{
		...
		DOTween.To(() => playerTextCanvasGroup.alpha, x => playerTextCanvasGroup.alpha = x, 0, 1f).SetEase(Ease.InQuad).OnComplete(() => SceneManager.LoadScene("Scene1"));
